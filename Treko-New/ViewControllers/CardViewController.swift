...
class CardViewController: UIViewController {
    ...
    private func setupUI() {
        ...
        let counts = [1, 5, 5, 10, 15, 25, 30, 20, 20, 30, 30, 5, 10, 15, 5, 20, 10, 15, 20, 10, 30, 15, 5, 10, 30, 25, 20, 10, 5, 20, 30, 15, 10, 5, 20, 10, 30, 15, 5, 20, 10, 25, 30, 5, 15, 10, 20, 5, 30, 15, 25, 10, 5, 20, 30, 15, 5, 10, 25, 20, 30, 5, 15, 10, 20, 5, 30, 15, 25, 10, 5, 20, 30, 15, 5, 10, 25, 20, 30, 5, 15, 10, 20, 5, 30, 15, 25, 10, 5, 20, 30, 15, 5, 10, 25, 20, 30, 5, 15, 10, 20, 5, 30, 15, 25, 10, 5, 20, 30, 15, 5, 10, 25, 20, 30, 5, 15, 10, 20, 5, 30, 15, 25, 10, 5, 20, 30, 15, 5, 10, 25, 20, 30, 5, 15, 10, 20, 5, 30, 15, 25]
        ...
        overlayView.addSubview(headingLabel)
        ...
        NSLayoutConstraint.activate([
            headingLabel.topAnchor.constraint(equalTo: overlayView.topAnchor, constant: 16),
            headingLabel.leadingAnchor.constraint(equalTo: overlayView.leadingAnchor),
            headingLabel.trailingAnchor.constraint(equalTo: overlayView.trailingAnchor),
        ...
        NSLayoutConstraint.activate([
            ...
            textView.topAnchor.constraint(equalTo: headingLabel.bottomAnchor, constant: 16),
